...
/// AlertView Icon 绘制工具
class AlertViewDrawKit: NSObject {
    // Cache
    struct Cache {
    ...
    class var imageOfCheckmark: UIImage {
        ...
        AlertViewDrawKit.drawCheckmark()
    ...
    class var imageOfQuestion: UIImage {
        ...
        UIGraphicsBeginImageContextWithOptions(CGSize(width: 80, height: 80), false, 0)
        AlertViewDrawKit.drawQuestion()
        Cache.imageOfQuestion = UIGraphicsGetImageFromCurrentImageContext()
        UIGraphicsEndImageContext()
        return Cache.imageOfQuestion!
    }
    
    // MARK:- Drawing Methods 绘制方法（私有）
    fileprivate class func drawCheckmark() {
    ...
    fileprivate class func drawCross() {
        // Cross Shape Drawing
    ...
    fileprivate class func drawNotice() {
    ...
    fileprivate class func drawWarning() {
        // Color Declarations
    ...
    fileprivate class func drawInfo() {
        // Color Declarations
    ...
    fileprivate class func drawEdit() {
        // Color Declarations
    ...
    fileprivate class func drawQuestion() {
        // Color Declarations
